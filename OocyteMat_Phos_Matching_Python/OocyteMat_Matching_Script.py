...
# import the step#_match functions
...
"XenFastaIn": '../CoreAnalysisFiles/XENLA_9.2_Xenbase_plusMT.pep.fa', \
'XenRefsResidues': '../OocyteMat_IntermediateFilesIN_220118/220119_OocyteMat_RESIDUES_4match2human.txt', \
'XenRefs_Sep': '\t', 'XenRefs_Quote': '"', 'XenRefs_Col': 1, 'XenResidue_Col': \
2, 'XenRes_Sep': ";", 'OutputFile': "OocyteMat_HumanMatch_01192022.csv"};
...
# 8 --- Part (iii) Write an output file where each phosphorylated xenopus
